...
<body>
    ...
    <input type="datetime" id="date" placeholder="date">
    <div id="content">
    ...
    <div id="btnDiv">
        <a href = "/controller/update/${bno}"><button type="button" class="btns save">수정하기</button></a>
        <a href="home" class="btns back">뒤로 가기</a>
    </div>
...
//	        const postId = Number(searchParams.get('id'));
	        ...
	        // 2. API 호출
	        const url = '/controller/api/posts/${bno}';
